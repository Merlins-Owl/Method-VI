...
pub async fn execute_step_1(
    ...
    let mut orchestrator = {
        ...
        let mut orch = orch_guard
            .take()
            .ok_or_else(|| "No active run found. Please complete Step 0 first.".to_string())?;
    ...
    let (_intent_anchor_id, _charter_id, _baseline_id, _architecture_id) = orchestrator
        .execute_step_1()
        .await
        .map_err(|e| format!("Failed to execute Step 1: {}", e))?;
